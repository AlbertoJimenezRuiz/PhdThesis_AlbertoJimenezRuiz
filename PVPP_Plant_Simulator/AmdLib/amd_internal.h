...
#define PRINTF(params)                                                         \
  { (void)mexPrintf params; }
#else
#ifdef MATHWORKS
#define PRINTF(params)                                                         \
  { (void)utPrintf params; }
#else
#define PRINTF(params)                                                         \
  { (void)printf params; }
#endif
...
GLOBAL Int AMD_aat(Int n, const Int Ap[], const Int Ai[], Int Len[], Int Tp[],
                   double Info[]);
...
GLOBAL void AMD_2(Int n, Int Pe[], Int Iw[], Int Len[], Int iwlen, Int pfree,
...
GLOBAL void AMD_wpreprocess(Int n, const Int Ap[], const Int Ai[], Int Rp[],
                            Int Ri[], Int W[], Int Flag[]);

GLOBAL Int AMD_preprocess_valid(Int n, const Int Ap[], const Int Ai[]);
